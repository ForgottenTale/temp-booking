        ...
        if(serviceName=="zoom"){
            ...
            .then(data=>{
                try{
                    ...
                    data= data.data;
                    connection.query(`UPDATE online_meeting INNER JOIN blt ON online_meeting_id=blt._id SET meeting_id='${data.id}', meeting_url='${data.join_url}', meeting_password = '${data.password}'
