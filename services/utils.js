        ...
        if(serviceName=="zoom"){
            ...
            .then(data=>{
                try{
                    ...
                    data= data.data;
                    connection.query(`UPDATE blt.online_meeting INNER JOIN online_meeting ON online_meeting_id=online_meeting._id SET meeting_id='${data.id}', meeting_url='${data.join_url}', meeting_password = '${data.password}'
